...
<div>
    ...
    <div class="tm_bottom">
    	<div class="tm_btn_style large" onclick="location.href='${pageContext.request.contextPath}/hostPage/rooms?page=${page}&option=${option}';">객실관리로 이동</div>
        <div class="tm_btn_style large" onclick="location.href='${pageContext.request.contextPath}/host/rooms/${room.roomNum}/update?page=${page}&option=${option}';">수정하기</div>
    </div>
