...
<table class='table table-borderless'>
	<c:forEach var="vo" items="${listReply}">
		...
		<tr>
			<td colspan='2' valign='top'>${vo.boardRe_content}</td>
		</tr>

		<tr>
			<td>
				<button type='button' class='btn btn-light btnReplyAnswerLayout' data-boardRe_num='${vo.boardRe_num}'>답글 <span id="answerCount${vo.boardRe_num}">${vo.answerCount}</span></button>
			</td>
	    ...
	    <tr class='reply-answer'>
	        <td colspan='2'>
	        	<div class='border rounded'>
		            <div id='listReplyAnswer${vo.boardRe_num}' class='answer-list'></div>
		            <div>
