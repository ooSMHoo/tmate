...
<script type="text/javascript">
	function dialogLogin() {
	    $("form[name=modelLoginForm] input[name=memberId]").val("");
	    $("form[name=modelLoginForm] input[name=memberPwd]").val("");
	    
		$("#loginModal").modal("show");	
		
	    $("form[name=modelLoginForm] input[name=memberId]").focus();
	}
			...
			<div class="modal-body">
                <div class="p-3">
                    <form name="modelLoginForm" action="" method="post" class="row g-3">
                        ...
                        <div>
                            <input type="password" name="memberPwd" class="form-control" placeholder="패스워드">
                        </div>
                        <div>
