      ...
      <li class="mb-1 icon-set3">
        ...
        <div class="collapse " id="dashboard-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small left-accordion-body">
            <li><a href="#" class="link-dark rounded menu-font">호스트정보</a></li>
            <li><a href="#" class="link-dark rounded menu-font">숙소등록</a></li>
            <li><a href="#" class="link-dark rounded menu-font" style="border-bottom: 1px solid #fff;">객실등록</a></li>
          </ul>
        </div>
      </li> 
    </ul>
